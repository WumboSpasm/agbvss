...
// Global Variables.
/////////////////////////////////////////////////
extern u16 Lev1bg1_Palette[256]; 		// Colour palette data (shared 256 colours for all backgrounds).
...
u16	x_tilepos;	// 16-bit map x-axis tile position.
u16	y_tilepos;	// 16-bit map y-axis tile position.

u16 x_shift;	// 16-bit map x-axis fine shift store.
u16 y_shift;	// 16-bit map y-axis fine shift store.
